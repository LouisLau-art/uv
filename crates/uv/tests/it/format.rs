...
fn format_version_constraints() -> Result<()> {
    ...
    uv_snapshot!(context.filters(), context.format().arg("--version").arg(">=0.8.0"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_version_latest() -> Result<()> {
    ...
    uv_snapshot!(context.filters(), context.format().arg("--version").arg("latest"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
...
fn format_exclude_newer() -> Result<()> {
    ...
    uv_snapshot!(context.filters(), context.format().arg("--exclude-newer").arg("2026-01-01").arg("--version").arg("latest"), @"
    success: true
    exit_code: 0
    ----- stdout -----
    1 file reformatted
